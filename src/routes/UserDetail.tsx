  ...
  return (
    <Flex justifyContent="center" alignItems="center">
      <VStack spacing="20px" as="form" onSubmit={handleSubmit(onSubmit)}>
        <Heading as={"dt"}>ユーザ情報</Heading>
        <Text as={"dd"}>ログインID:{user?.username}</Text>
        <Text>ユーザ名</Text>
        {isEditingName ? (
          <Input
            type="text"
          ...
          <Box>
            <Text>
              {user?.name}
              <Button ml="24px" onClick={handleNameButtonClick}>
                変更
              </Button>
            </Text>
          </Box>
        ...
        {isEditingPassword ? (
          ...
          <Box>
            <Text>
              {old_password}
              <Button ml="24px" onClick={handlePasswordButtonClick}>
                変更
              </Button>
            </Text>
          </Box>
